...
# ----------------------
  ...
  it '11. sorts the orders from least expensive to most expensive' do
    ...
    # same query would be Order.order(amount: :asc) OR
  ...
  it '12. should return all items except items 2, 5 and 6' do
    ...
    # In where statement when looking for ID you can pass in object as above or the id as below
  ...
  it "13. groups an order's items by name" do
    ...
    # OR the below also pass the test but that may be a coincidence of order
    # grouped_items = @order_3.items
    #  Order.find(@order_3.id).items
    # ------------------------------------------------------------
